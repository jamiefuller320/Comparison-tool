        ...
        <div className="shell">
          ...
          <div className="footnote">
            ...
            <p>
              ...
              a school-by-school scorecard. Pure secondary schools come from GIAS for
              KS3/KS4 search; KS2 attainment figures appear where published for state
              schools. Independents are compared on published Key Stage 4 outcomes
              (nil/zero English &amp; maths GCSE returns cleared; EBacc subject pillars
              used as fallbacks), Ofsted grades for non-association schools, and
              ISI/website links from GIAS when Ofsted grades are absent. Small cohorts
              bounce around more than large ones. Admissions rules and ethos are still
        ...
        <div className="shell">
          ...
          <div className="footnote">
            <p>
              ...
              early-years intake, plus EYFSP England/Hampshire area context
              (provider-level EYFSP is not published — Ofsted grades and EYFSP
              area figures answer different questions). State schools: institution-level
              Key Stage 2 attainment plus local-authority phonics for KS1.
